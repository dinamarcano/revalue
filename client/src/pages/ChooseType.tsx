...
export default function ChooseType() {
  ...
  return (
    <div className="min-h-screen bg-[#2EBB4E] flex flex-col justify-between">
      ...
      {/* PANEL BLANCO GRANDE */}
      <div className="bg-white rounded-t-[20px] pt-10 pb-16 px-6 flex flex-col items-center">

        {/* DOTS */}
        <div className="flex gap-2 mb-10">
          <div className={`w-3 h-3 rounded-full ${step === "choose" ? "bg-[#2EBB4E]" : "bg-gray-300"}`} />
          <div className={`w-3 h-3 rounded-full ${step === "selected" ? "bg-[#2EBB4E]" : "bg-gray-300"}`} />
        </div>
        ...
        {step === "choose" ? (
          <>
            <button
              ...
              className="w-full max-w-xs py-4 mb-4 rounded-2xl bg-[#2EBB4E]/40 text-white text-lg font-semibold cursor-not-allowed"
            >
              Gatherers
            </button>
          ...
          <>
            <button
              ...
              className="w-full max-w-xs py-4 mb-4 rounded-2xl bg-[#2EBB4E] text-white text-lg font-semibold"
            >
              Login
            </button>
